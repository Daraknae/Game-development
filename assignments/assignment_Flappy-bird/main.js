...
/*
Defining this function for the P5.js library to call. The key we want to
listen for the press of is the spacebar. When the spacebar is hit,
we want the bird to "fly" up.
*/
function keyPressed() {
